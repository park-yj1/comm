...
public class MyPageController {
	...
	//회원 정보 수정
	@PostMapping("/info")		//(@ModelAttribute("loginMember")) session 데이터
...
//							String currentPw, String newPw
	...
	public String updateProfile(@ModelAttribute("loginMember") Member loginMember
		...
		if(result>0) {
			...
			// DB 랑 세션 동기화
			// 서비스 호출시 전달된 map은 실제로는 주소만 전달 (얕은복사)
